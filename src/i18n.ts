...
const resources = {
  en: {
    translation: {
      ...
      "nav.availability": "Unavailability",
      "nav.availability.manage": "Manage Unavailability",
      ...
      "availability.title": "Car Unavailability Management",
      "availability.subtitle": "Mark cars as unavailable for specific periods",
      "availability.addPeriod": "Add Unavailability Period",
      "availability.editPeriod": "Edit Unavailability Period",
      ...
      "availability.types.booking": "Office Booking",
      ...
      "availability.form.reasonPlaceholder": "Enter reason for blocking",
      "availability.success.created": "Unavailability period created successfully",
      "availability.success.updated": "Unavailability period updated successfully",
      "availability.success.deleted": "Unavailability period deleted successfully",
      "availability.errors.loadCars": "Failed to load cars",
      "availability.errors.loadData": "Failed to load unavailability data",
      "availability.errors.save": "Failed to save unavailability period",
      "availability.errors.delete": "Failed to delete unavailability period",
  ...
  ar: {
    translation: {
        ...
        "nav.availability": "عدم التوفر",
        "nav.availability.manage": "إدارة عدم التوفر",
        ...
        // Availability Management
        "availability.title": "إدارة عدم توفر السيارات",
        "availability.subtitle": "تحديد فترات عدم توفر السيارات",
