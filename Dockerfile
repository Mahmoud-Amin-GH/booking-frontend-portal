...
ARG REACT_APP_FORSALE_SERVICES_API_BASE_URL
ARG REACT_APP_FORSALE_INTEGRATIONS_API_BASE_URL
...
ENV REACT_APP_FORSALE_SERVICES_API_BASE_URL=$REACT_APP_FORSALE_SERVICES_API_BASE_URL
ENV REACT_APP_FORSALE_INTEGRATIONS_API_BASE_URL=$REACT_APP_FORSALE_INTEGRATIONS_API_BASE_URL
